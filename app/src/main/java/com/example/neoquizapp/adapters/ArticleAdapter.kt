...
import com.example.neoquizapp.databinding.CardArticleBinding
...
class ArticleAdapter(private var articles: List<Article>) :
    ...
    inner class ArticleViewHolder(private val binding: CardArticleBinding) :
        ...
        fun bind(article: Article) {
            ...
            binding.articleTime.text = "${article.reading_time_minutes} minutes"
